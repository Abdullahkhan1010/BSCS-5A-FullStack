...
const EditCook = () => {
  ...
  useEffect(() => {
    ...
    if (storedCooks) {
      const cooks = JSON.parse(storedCooks);
  ...
  const handleSubmit = (e) => {
    ...
    const updatedCooks = cooks.map(cook => 
      cook.id === id ? { ...formData, experience: parseInt(formData.experience) } : cook
    );
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 py-8">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8 animate-slide-up">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Edit Cook</h1>
          <p className="text-gray-600">Update cook information</p>
        </div>
